...
class DINO(nn.Module):
    ...
    def forward(self, samples: NestedTensor, targets:List=None, return_features=False):
        ...
        if return_features:
            return [feature.tensors for feature in features]
        srcs = []
        masks = []
        ...
        if self.num_feature_levels > len(srcs):
            ...
            for l in range(_len_srcs, self.num_feature_levels):
                ...
                m = samples.mask #TODO: have to create the mask here
